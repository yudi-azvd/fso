...
main() {
  test_cases=(
    "SIGINT SIGINT SIGUSR1 SIGINT SIGUSR2 SIGTERM SIGUSR1"
    "SIGUSR1 SIGUSR1 SIGINT SIGUSR2 SIGTERM SIGTERM SIGUSR1 SIGINT SIGUSR2 SIGTERM SIGUSR1"
    "SIGUSR1 SIGTERM SIGUSR1 SIGTERM SIGINT SIGUSR2 SIGTERM SIGTERM SIGTERM SIGTERM SIGINT SIGTERM SIGUSR2 SIGUSR1 SIGINT SIGINT SIGUSR2 SIGTERM SIGUSR1"
    "SIGUSR1"
  )
